...
/* themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-body.html.twig */
class __TwigTemplate_5c3d6a5d5941c8003488648c33109918 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 56
                    echo "      <p class=\"a-text a-text--header-navigation h-text-formatted\">";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_striptags($this->sandbox->ensureToStringAllowed((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 56)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#text"] ?? null) : null), 56, $this->source)), "html", null, true);
                    echo "</p>
    ";
                }
                $_parent = $context['_parent'];
...
";
    ...
    {
        return "themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-body.html.twig";
    }
    ...
    {
        return array (  132 => 71,  128 => 69,  125 => 68,  114 => 66,  109 => 65,  105 => 63,  103 => 62,  97 => 61,  92 => 60,  88 => 58,  79 => 56,  74 => 55,  70 => 53,  59 => 51,  55 => 50,  50 => 49,  47 => 48,  45 => 47,  42 => 46,  40 => 43,  39 => 42,);
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <p class=\"a-text a-text--header-navigation h-text-formatted\">{{ item.content[\"#text\"]|striptags }}</p>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes }}>
...
{% endif %}
", "themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-body.html.twig", "/app/web/themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-body.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 42, "if" => 47, "for" => 50);
        static $filters = array("escape" => 49, "striptags" => 56);
