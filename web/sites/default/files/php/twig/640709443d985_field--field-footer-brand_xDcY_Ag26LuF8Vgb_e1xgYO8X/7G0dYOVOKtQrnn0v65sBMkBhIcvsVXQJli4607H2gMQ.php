...
/* themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-title.html.twig */
class __TwigTemplate_009360642263cc8faf33319e010122f1 extends Template
{
    private $source;
    private $macros = [];
...
($context["label_display"] ?? null) == "visually_hidden")) ? ("visually-hidden") : (""))];
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 55
                    echo "      <h5 class=\"a-text a-text--header-5-bold h-text-formatted\" >";
...
";
    ...
    {
        return "themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-title.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <h5 class=\"a-text a-text--header-5-bold h-text-formatted\" >{{ item.content }}</h5>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes }}>
...
{% endif %}
", "themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-title.html.twig", "/app/web/themes/custom/storytheme/templates/field/footer-brand/field--field-footer-brand-title.html.twig");
    }
